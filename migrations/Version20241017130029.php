 ...
 */
final class Version20241017130029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, micro_post_id INT NOT NULL, author_id INT NOT NULL, text VARCHAR(500) NOT NULL, created DATETIME NOT NULL, INDEX IDX_9474526C11E37CEA (micro_post_id), INDEX IDX_9474526CF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
